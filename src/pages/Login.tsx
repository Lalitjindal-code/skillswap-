...
import { Mail, Lock, ArrowRight, User, LogOut, LayoutDashboard, Sparkles } from 'lucide-react';
...
export default function Login() {
  ...
  const { login, signup, loginWithGoogle, user, logout } = useGlobal();
  ...
  // If already logged in, show "Session Gate" (Optional - but the useEffect might execute fast enough to skip this)
  // We'll keep this as a fallback or for verify-email edge cases where user is technically logged in but stuck.
